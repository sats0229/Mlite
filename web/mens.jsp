                ...
                <div class="col-md-8 products-right">
                    ...
                    <div class="col-md-4 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            ...
                            <div class="item-info-product ">
                                <h4><a href="view.jsp">Party Men's Blazer</a></h4>
                                <div class="info-product-price">
                                    <span class="item_price">Rs.260.99</span>
                                    <del>Rs.390.71</del>
                                </div>
                    ...
                    <div class="col-md-4 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            ...
                            <div class="item-info-product ">
                                <h4><a href="view.jsp">Analog Watch</a></h4>
                                <div class="info-product-price">
                ...
                <div class="single-pro">
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            ...
                            <div class="item-info-product ">
                                <h4><a href="view.jsp">Formal Blue Shirt</a></h4>
                                <div class="info-product-price">
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            ...
                            <div class="item-info-product ">
                                <h4><a href="view.jsp">Gabi Full Sleeve Sweatshirt</a></h4>
                                <div class="info-product-price">
                                    <span class="item_price">Rs.45.99</span>
                                    <del>Rs.69.71</del>
                                </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            ...
                            <div class="item-info-product ">
                                <h4><a href="view.jsp">Dark Blue Track Pants</a></h4>
                                <div class="info-product-price">
                                    <span class="item_price">Rs.80.99</span>
                                    <del>Rs.89.71</del>
                                </div>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            ...
                            <div class="item-info-product ">
                                <h4><a href="view.jsp">Round Neck Black T-Shirt</a></h4>
                                <div class="info-product-price">
                                    <span class="item_price">Rs.190.99</span>
                                    <del>Rs.159.71</del>
                                </div>
                                <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
                                    <form action="#" method="post">
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            ...
                            <div class="item-info-product ">
                                <h4><a href="view.jsp">Men's Black Jeans</a></h4>
                                <div class="info-product-price">
                                    <span class="item_price">Rs.60.99</span>
                                    <del>Rs.90.71</del>
                                </div>
                                <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
                                    <form action="#" method="post">
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            ...
                            <div class="item-info-product ">
                                <h4><a href="view.jsp">Reversible Belt</a></h4>
                                <div class="info-product-price">
                                    <span class="item_price">Rs.30.99</span>
                                    <del>Rs.50.71</del>
                                </div>
                                <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
                                    <form action="#" method="post">
                    ...
                    <div class="sign-grds">
                        <div class="col-md-4 sign-gd">
                            ...
                            <ul>
                                ...
                                <li><a href="mens.html">Top's Wear</a></li>
