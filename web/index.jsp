<%-- 
    Document   : index
    Created on : Aug 12, 2018, 2:30:12 PM
    Author     : HEROS
--%>
...
<html>
    <head>
        ...
        <meta name="keywords" content="Mlite Shop Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
      ...
      if(session.getAttribute("username")!=null)
{
        ...
        <div class="header" id="home">
            <div class="container">
                ...
                <ul><%if(session.getAttribute("username")!=null)
                {%><li> <a href="welcome.jsp" >Hi,&nbsp;<%=user%>&nbsp;</a><a href="Logout?type=u">|&nbsp;SignOut</a></li>
                <li> <a href="welcome.jsp" >My Account</a>
        ...
        <div class="header-bot">
            <div class="header-bot_inner_wthreeinfo_header_mid">
                ...
                <div class="col-md-4 logo_agile">
                    <h1><a href="index.jsp"><span>M</span>lite Shop <h6><i>for mens..</i></h6><i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
                </div>
                <!-- header-bot -->
            ...
            <div class="container">
                            ...
                            <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav menu__list">
                                    ...
                                    <li class="dropdown menu__item">
                                        <a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Top's wear <span class="caret"></span></a>
                                    ...
                                    <li class="dropdown menu__item">
                                        <a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Bottom's wear <span class="caret"></span></a>
                                        <ul class="dropdown-menu multi-column columns-3">
                                            <div class="agile_inner_drop_nav_info">
                                                <div class="col-sm-3 multi-gd-img">
                                                    <ul class="multi-column-dropdown">
                ...
                <div class="top_nav_right">
                    <div class="wthreecartaits wthreecartaits2 cart cart box_1"> 
                        <form action="InCart" method="post" class="last"> 
<!--                            <input type="hidden" name="cmd" value="_cart">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body modal-body-sub_agile">
                        <div class="col-md-8 modal_body_left modal_body_left1">
                            ...
                            <form action="verifyuser?type=u" method="post">
        ...
        <div class="new_arrivals_agile_w3ls_info"> 
            <%
               ...
               List<String> productcategoryList= DAOOperations.getProductCategories();
            ...
            <div class="container">
                ...
                <div id="horizontalTab">
                    <ul class="resp-tabs-list">
                        <%for(String pr:productcategoryList)
                        {%>
                        <li onclick="getProdDetails(this)" id="li1" value="<%=pr%>"> <%=pr%></li>
                        <!--<li> Trousers</li>
                        <li> Bags</li>
                        <li> Footwear</li>-->
                        <%}%>
                           ...
                           <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="view.jsp">Running Shoes</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">Rs.80.99</span>
                                            <del>Rs.89.71</del>
                                        </div>
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="view.jsp">Shoetopia Lace Up</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">Rs.90.99</span>
                                            <del>Rs.59.71</del>
                                        </div>
                                        <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
                                            <form action="#" method="post">
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="view.jsp">Steemo Casuals(Black)</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">Rs.90.99</span>
                                            <del>Rs.59.71</del>
                                        </div>
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="view.jsp">Benetton Flip Flops</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">Rs.40.99</span>
                                            <del>Rs.99.71</del>
                                        </div>
                                        <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
                                            <form action="#" method="post">
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="view.jsp">Moonwalk Bellies </a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">Rs.80.99</span>
                                            <del>Rs.99.71</del>
                                        </div>
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="view.jsp">Aero Canvas Loafers  </a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">Rs.120.99</span>
                                            <del>Rs.199.71</del>
                                        </div>
                                        <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
                                            <form action="#" method="post">
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="view.jsp">Sparx Sporty Canvas Shoes</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">Rs.160.99</span>
                                            <del>Rs.199.71</del>
                                        </div>
                                        <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
                                            <form action="#" method="post">
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="view.jsp">Men BLACK Heels</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">Rs.180.99</span>
                                            <del>Rs.199.71</del>
                                        </div>
                                        <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
                                            <form action="#" method="post">
        ...
        <div class="sale-w3ls">
            <div class="container">
                ...
                <a class="hvr-outline-out button2" href="view.jsp">Shop Now </a>
            </div>
        </div>
        <!-- //we-offer -->
        <!--/grids-->
        ...
        <div class="footer">
            <div class="footer_agile_inner_info_w3l">
                <div class="col-md-3 footer-left">
                    <h2><a href="index.jsp"><span>M</span>lite Shop </a></h2>
                    ...
                    <div class="sign-grds">
                        <div class="col-md-4 sign-gd">
                            ...
                            <ul>
                                ...
                                <li><a href="mens.jsp">Top's Wear</a></li>
                                <li><a href="#">Bottom's wear</a></li>
                                <li><a href="#">Accessories</a></li>
                        ...
                        <div class="col-md-3 sign-gd flickr-post">
                            ...
                            <ul>
                                <li><a href="view.jsp"><img src="images/t1.jpg" alt=" " class="img-responsive" /></a></li>
                                <li><a href="view.jsp"><img src="images/t2.jpg" alt=" " class="img-responsive" /></a></li>
                                <li><a href="view.jsp"><img src="images/t3.jpg" alt=" " class="img-responsive" /></a></li>
                                <li><a href="view.jsp"><img src="images/t4.jpg" alt=" " class="img-responsive" /></a></li>
                                <li><a href="view.jsp"><img src="images/t1.jpg" alt=" " class="img-responsive" /></a></li>
                                <li><a href="view.jsp"><img src="images/t2.jpg" alt=" " class="img-responsive" /></a></li>
                                <li><a href="view.jsp"><img src="images/t3.jpg" alt=" " class="img-responsive" /></a></li>
                                <li><a href="view.jsp"><img src="images/t2.jpg" alt=" " class="img-responsive" /></a></li>
                ...
                <p class="copy-right">&copy 2017 Mlite shop. All rights reserved</p>
            </div>
        </div>
        <!-- //footer -->
